...
import Aboutuspic from "../pictures/aboutuspic.jpg";
    ...
    return (
        <div className="aboutus">
            ...
            <Card className="card shadow" style={{ backgroundColor: 'rgb(237, 235, 235)' }}>
                <Card.Body>
                <img src={Aboutuspic} alt="About Us" style={{ boarderRadius:10 ,display: 'block', margin: 'auto', maxWidth: '100%', height: 'auto' ,marginBottom:50}} /> {/* Center the image */}
